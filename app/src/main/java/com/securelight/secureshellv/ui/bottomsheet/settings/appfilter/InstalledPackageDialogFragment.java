 ...
 */
public class InstalledPackageDialogFragment extends DialogFragment {
     ...
     */
    public InstalledPackageDialogFragment() {
    }

    public static InstalledPackageDialogFragment newInstance() {
        return new InstalledPackageDialogFragment();
    }
